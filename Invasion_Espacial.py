...
# Variables Jugador
img_jugador = pygame.image.load("cohete (1).png")
jugador_x = 368
jugador_y = 500
jugador_x_cambio = 0
...
def hay_colision(x_1, y_1, x_2, y_2):
    distanica = math.sqrt(math.pow(x_1 - x_2, 2) + math.pow(y_2 - y_1, 2) )
    if distanica < 27:
        return True
    else:
        return False
...
while se_ejecuta:
    ...
    # Modificar ubiacaión del jugador
    ...
    # Modificar ubiacaión del enemigo
    for e in range(cantidad_enemigos):
